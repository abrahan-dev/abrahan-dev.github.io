...
layout: post
title: "Good Code"
date: 2023-09-14 00:00:00 +0200
categories: ["thoughts"]
excerpt: ""
source_path: "posts/2023-09-14-good-code.md"
---
{% raw %}
## Introduction
...
![Alt text](/assets/images/clean-architecture.png)
...
Check out this post I wrote specifically on testing: [Testing](/archive/)

### Code review

Check out this post I wrote on code reviews: [Code review](/archive/)
...
I have created this repo [Architecture example](/archive/). A try of creating an architecture example for a web application in typescript inspired somehow by the tactical part of domain driven design and clean architecture.

Other posts that I have written about this topic:

-   [Simplicity in code](/archive/)
-   [Ports and Adapters](/archive/)
-   [Testing](/archive/)
-   [Code review](/archive/)
